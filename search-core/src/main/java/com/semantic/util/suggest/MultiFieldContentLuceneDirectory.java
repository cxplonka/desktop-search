...
public class MultiFieldContentLuceneDirectory implements Dictionary {
    ...
    public MultiFieldContentLuceneDirectory(IndexReader reader, String... fields) {
        this.reader = reader;
        this.fields = fields;
    }
    ...
    class FieldValueBytesRefIterator implements InputIterator {

        final BytesRefIterator[] iterators;
        private int idx = 0;

        public FieldValueBytesRefIterator(BytesRefIterator... iterators) {
